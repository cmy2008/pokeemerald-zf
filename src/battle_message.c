...
static const u8 sText_PlayerUsedItem[] = _("你使用了\n{B_LAST_ITEM}！");
...
static const u8 sText_TargetChangedType[] =_("{B_DEF_NAME_WITH_PREFIX}变成了水系！");
...
static const u8 sText_ClearAmuletWontLowerStats[] = _("{B_DEF_NAME_WITH_PREFIX}的{B_BUFF1}\n没有降低!");
...
const u8 gText_WhatWillWallyDo[] = _("小光要做\n什么？");
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT DARK_GRAY}原野球");
