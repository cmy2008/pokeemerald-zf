...
static const u8 sDebugText_Sound[] =            _("音效…{CLEAR_TO 110}{RIGHT_ARROW}");
...
static const u8 sDebugText_Battle_0_WildDouble[] =  _("野生 Double…{CLEAR_TO 110}{RIGHT_ARROW}");
...
// Fill Menu
static const u8 sDebugText_Fill_Pc_Fast[] =             _("填充 PCBoxes Fast");
static const u8 sDebugText_Fill_Pc_Slow[] =             _("填充 PCBoxes Slow (LAG!)");
