...
// unused text
static const u8 sUnusedText_YesNo[] = _("是\n否");
static const u8 sUnusedText_2[] = _("▶");
static const u8 sUnusedText_Space[] = _(" ");
static const u8 sUnusedText_Terminating[] = _("终止。");
static const u8 sUnusedText_LinkPartnerNotFound[] = _("找不到连接伙伴\n请重试。\p");

static const u8 sText_BerryBlenderStart[] = _("启动树果搅拌机\p请从包中选择一种树果\p放入树果搅拌机\p");
static const u8 sText_NewParagraph[] = _("\p");
static const u8 sText_WasMade[] = _(" 制作!");
static const u8 sText_Mister[] = _("先生");
static const u8 sText_Laddie[] = _("少年");
static const u8 sText_Lassie[] = _("少女");
static const u8 sText_Master[] = _("主人");
static const u8 sText_Dude[] = _("伙计");
static const u8 sText_Miss[] = _("女士");
...
static const u8 sText_PressAToStart[] = _("按A键开始");
static const u8 sText_PleaseWaitAWhile[] = _("请等待");
static const u8 sText_CommunicationStandby[] = _("通讯待机…");
static const u8 sText_WouldLikeToBlendAnotherBerry[] = _("你想再搅拌一个树果吗?");
static const u8 sText_RunOutOfBerriesForBlending[] = _("你的树果搅拌完了\p");
static const u8 sText_YourPokeblockCaseIsFull[] = _("你的{POKEBLOCK}口袋满了\p");
static const u8 sText_HasNoBerriesToPut[] = _(" 没有树果可以放进搅拌机");
static const u8 sText_ApostropheSPokeblockCaseIsFull[] = _("的{POKEBLOCK}口袋满了\p");
static const u8 sText_BlendingResults[] = _("成果");
static const u8 sText_BerryUsed[] = _("用过的树果");
...
static const u8 sText_MaximumSpeed[] = _("极限速度");
static const u8 sText_RPM[] = _("转速");
static const u8 sText_Dot[] = _("。");
static const u8 sText_NewLine[] = _("\n");
static const u8 sText_Space[] = _(" ");
static const u8 sText_Ranking[] = _("排名");
static const u8 sText_TheLevelIs[] = _("级别是");
static const u8 sText_TheFeelIs[] = _("，感受是");
