...
{
    [NATURE_HARDY] = COMPOUND_STRING("勤奋"),
    [NATURE_LONELY] = COMPOUND_STRING("孤独"),
    [NATURE_BRAVE] = COMPOUND_STRING("勇敢"),
    [NATURE_ADAMANT] = COMPOUND_STRING("固执"),
    [NATURE_NAUGHTY] = COMPOUND_STRING("顽皮"),
    [NATURE_BOLD] = COMPOUND_STRING("大胆"),
    [NATURE_DOCILE] = COMPOUND_STRING("温和"),
    [NATURE_RELAXED] = COMPOUND_STRING("悠闲"),
    [NATURE_IMPISH] = COMPOUND_STRING("淘气"),
    [NATURE_LAX] = COMPOUND_STRING("乐天"),
    [NATURE_TIMID] = COMPOUND_STRING("胆小"),
    [NATURE_HASTY] = COMPOUND_STRING("急躁"),
    [NATURE_SERIOUS] = COMPOUND_STRING("认真"),
    [NATURE_JOLLY] = COMPOUND_STRING("开朗"),
    [NATURE_NAIVE] = COMPOUND_STRING("天真"),
    [NATURE_MODEST] = COMPOUND_STRING("内敛"),
    [NATURE_MILD] = COMPOUND_STRING("慢吞吞"),
    [NATURE_QUIET] = COMPOUND_STRING("冷静"),
    [NATURE_BASHFUL] = COMPOUND_STRING("害羞"),
    [NATURE_RASH] = COMPOUND_STRING("浮躁"),
    [NATURE_CALM] = COMPOUND_STRING("温顺"),
    [NATURE_GENTLE] = COMPOUND_STRING("温柔"),
    [NATURE_SASSY] = COMPOUND_STRING("自大"),
    [NATURE_CAREFUL] = COMPOUND_STRING("谨慎"),
    [NATURE_QUIRKY] = COMPOUND_STRING("古怪"),
};
