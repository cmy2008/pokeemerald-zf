...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .height = 4,
        .weight = 41,
        .description = COMPOUND_STRING("毛茸茸的体毛有着近似于\n植物的成分。会勤于洗脸\n以防止干燥。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLORAGATO] =
    {
        ...
        .height = 9,
        .weight = 122,
        .description = COMPOUND_STRING("灵巧地操控长长的体毛下\n隐藏着的藤蔓，接着把\n坚硬的花苞甩向敌人。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEOWSCARADA] =
    {
        ...
        .height = 15,
        .weight = 312,
        .description = COMPOUND_STRING("花看似浮在空中，其实\n它是通过斗篷内的毛的\n反射来隐藏住了茎。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .height = 4,
        .weight = 98,
        .description = COMPOUND_STRING("火囊很小，因此能量会\n从头部的凹陷处溢出来，\n并摇曳晃动着。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROCALOR] =
    {
        ...
        .height = 10,
        .weight = 307,
        .description = COMPOUND_STRING("声带和火囊的阀紧邻在一\n起。会一边发出嘶哑的声\n音，一边喷洒火焰。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .height = 16,
        .weight = 3265,
        .description = COMPOUND_STRING("能以歌声改变外形的\n火鸟，据说是由灵魂寄宿\n在头上的火球所形成的。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .height = 5,
        .weight = 61,
        .description = COMPOUND_STRING("脚力之强，即使在水流湍\n急的河川也能自在游动。\n爱干净，性格有些顽固。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAXWELL] =
    {
        ...
        .height = 12,
        .weight = 215,
        .description = COMPOUND_STRING("通过在浅滩持续奔跑来锻\n炼腰腿，借此与伙伴比拼\n谁的腿技更为华丽。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAQUAVAL] =
    {
        ...
        .height = 18,
        .weight = 619,
        .description = COMPOUND_STRING("活用只要一脚就能踢翻卡\n车的强韧脚力，展现充满\n异国风情的舞蹈。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .height = 5,
        .weight = 102,
        .description = COMPOUND_STRING("一整天都在觅食。明明\n 拥有优秀的嗅觉，却只\n用来寻找食物。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define OINKOLOGNE_MISC_INFO                                \
    ...
    [SPECIES_OINKOLOGNE_MALE] =
    {
        ...
        .description = COMPOUND_STRING("以自己细致透亮的肌肤为\n傲。会从尾巴的前端释放\n出凝缩的香气。"),
    ...
    [SPECIES_OINKOLOGNE_FEMALE] =
    {
        ...
        .description = COMPOUND_STRING("会释放出如花般的香气。\n肌肉发达的腿可以轻而易\n举地跳过5米高。"),
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .height = 3,
        .weight = 40,
        .description = COMPOUND_STRING("从臀部射出的丝线的强度\n可以匹敌金属丝。强度的\n秘密至今仍在被研究中。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .height = 10,
        .weight = 165,
        .description = COMPOUND_STRING("会在自己的地盘里布下坚\n固又黏糊糊的丝线，来当\n做捕捉入侵者的陷阱。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOKIX] =
    {
        ...
        .height = 10,
        .weight = 175,
        .description = COMPOUND_STRING("认真起来时会靠折起的脚\n站起来进入决战模式。会\n在短时间内压制敌人。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PAWMI] =
    {
        ...
        .height = 3,
        .weight = 25,
        .description = COMPOUND_STRING("脸颊上的电囊尚未发达。\n必须拼命摩擦前脚的肉球\n才得以制造出电力。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .height = 3,
        .weight = 18,
        .description = COMPOUND_STRING("凭借默契十足的合作，\n用门牙切断能当作巢穴材\n料的东西，并将其搬走。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define MAUSHOLD_SPECIES_INFO                                                           \
    ...
    [SPECIES_MAUSHOLD_FAMILY_OF_THREE] =
    {
        ...
        .weight = 23,
        .description = COMPOUND_STRING("会制造巨大的巢穴，并根\n据用途来分出多个房间，\n包含寝室、餐厅等等。"),
    ...
    [SPECIES_MAUSHOLD_FAMILY_OF_FOUR] =
    {
        ...
        .weight = 28,
        .description = COMPOUND_STRING("身型大的2只会一边保护\n孩子一边战斗。对抗强大\n的对手时会集体出阵。"),
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .height = 3,
        .weight = 109,
        .description = COMPOUND_STRING("摸起来既湿润又光滑。吐\n息中包含的酵母可以让周\n围的东西发酵。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DACHSBUN] =
    {
        ...
        .height = 5,
        .weight = 149,
        .description = COMPOUND_STRING("它的皮肤表面拥有遇到高\n温就变硬的性质。身体散\n发着香香的气味。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .height = 3,
        .weight = 65,
        .description = COMPOUND_STRING("会把营养转换成油，并储\n存在头部的果实里。1个\n星期不吃不喝也无所谓。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DOLLIV] =
    {
        ...
        .height = 6,
        .weight = 119,
        .description = COMPOUND_STRING("乐于分享自己香气新鲜又\n美味可口的油。自古以来\n直至今日都与人类共存。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARBOLIVA] =
    {
        ...
        .height = 14,
        .weight = 482,
        .description = COMPOUND_STRING("会以连岩石都能粉碎的力\n道把香醇浓郁的油发射出\n去,击退敌人。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define SQUAWKABILLY_MISC_INFO                                  \
    ...
    [SPECIES_SQUAWKABILLY_GREEN_PLUMAGE] =
    {
        ...
        .bodyColor = BODY_COLOR_GREEN,
        .description = COMPOUND_STRING("喜欢栖息在街道上。会以\n羽毛的颜色来组队,然后\n展开领地之争。"),
    ...
    [SPECIES_SQUAWKABILLY_BLUE_PLUMAGE] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_HUSTLE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .description = COMPOUND_STRING("蓝色羽毛的群体把势力最\n大的绿色羽毛的群体视为\n竞争对手。"),
    ...
    [SPECIES_SQUAWKABILLY_WHITE_PLUMAGE] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_HUSTLE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_WHITE,
        .description = COMPOUND_STRING("不擅长单独行动。凝聚力\n很强,靠着与伙伴互相合\n作而生存了下来。"),
    ...
    [SPECIES_NACLI] =
    {
        ...
        .height = 4,
        .weight = 160,
        .description = COMPOUND_STRING("出生在地底的岩盐层。原\n意分享贵重的盐巴,因此\n在过去非常受到重视。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NACLSTACK] =
    {
        ...
        .height = 6,
        .weight = 1050,
        .description = COMPOUND_STRING("在体内压缩岩盐,以此形\n成坚硬的盐弹,发射后的\n威力连铁板都能贯穿。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GARGANACL] =
    {
        ...
        .height = 23,
        .weight = 2400,
        .description = COMPOUND_STRING("盐石巨灵的周围会有大量\n的宝可梦聚集而来,为了\n舔它那富含矿物质的盐。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .height = 6,
        .weight = 105,
        .description = COMPOUND_STRING("一旦进入战斗状态,火力\n就会上升至摄氏1000度。\n爱吃油脂含量高的树果。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .height = 15,
        .weight = 850,
        .description = COMPOUND_STRING("借立下诸多功勋的战士所\n穿的铠甲进化而来的样子\n。是忠心耿耿的宝可梦。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .height = 16,
        .weight = 620,
        .description = COMPOUND_STRING("双臂的火焰之剑是靠着得\n志前就亡命的剑士的怨念\n而燃烧。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .height = 3,
        .weight = 4,
        .description = COMPOUND_STRING("通过摇晃尾巴来发电。若\n感知到有危险,会闪烁头\n部来通知伙伴。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BELLIBOLT] =
    {
        ...
        .height = 12,
        .weight = 1130,
        .description = COMPOUND_STRING("只要伸缩胖嘟嘟的身体，\n就能让肚子上的发电脐产\n生大量的电气。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WATTREL] =
    {
        ...
        .height = 4,
        .weight = 36,
        .description = COMPOUND_STRING("当翅膀的骨头受到风吹时\n,就能制造电。会冲进海\n里让猎物触电并捕获。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KILOWATTREL] =
    {
        ...
        .height = 14,
        .weight = 386,
        .description = COMPOUND_STRING("通过膨胀喉咙增强电力。\n乘着风可以在1天内就飞\n上700公里。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MASCHIFF] =
    {
        ...
        .height = 5,
        .weight = 160,
        .description = COMPOUND_STRING("为了不被对手看扁而总是\n皱着一张脸,却反而会让\n哭泣的孩子破涕为笑。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MABOSSTIFF] =
    {
        ...
        .height = 11,
        .weight = 610,
        .description = COMPOUND_STRING("大大的喉囊里可以储存能\n量。会一口气释放能量将\n敌人轰飞。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRAFAIAI] =
    {
        ...
        .height = 7,
        .weight = 272,
        .description = COMPOUND_STRING("涂标客画出的图案会随个\n体而有所不同。一生都持\n续画着相同的图案。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .height = 6,
        .weight = 6,
        .description = COMPOUND_STRING("无法升天的灵魂在风的吹\n拂下被卷进枯草里,变成\n了宝可梦。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAMBLEGHAST] =
    {
        ...
        .height = 12,
        .weight = 60,
        .description = COMPOUND_STRING("会在干燥地带流浪。有极\n低的概率会大量出现,把\n一座城镇塞得满满当当。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .height = 9,
        .weight = 330,
        .description = COMPOUND_STRING("栖息在潮湿的森林里。它\n身上脱落的薄片富有嚼劲\n,非常美味。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOEDSCRUEL] =
    {
        ...
        .height = 19,
        .weight = 580,
        .description = COMPOUND_STRING("会在森林深处建造集体生\n活用的聚落。非常厌恶有\n外来者靠近。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
