...
static const u8 sText_SpaceMove[] = _("移动");
...
static const u8 sText_IsThisTradeOkay[] = _("要交换吗？");
static const u8 sText_Cancel[] = _("取消");
static const u8 sText_ChooseAPkmn[] = _("选择一只宝可梦");
static const u8 sText_Summary[] = _("查看");
static const u8 sText_Trade[] = _("交换");
static const u8 sText_CancelTrade[] = _("取消交换？");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("查看");
static const u8 sText_Trade2[] = _("交换");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}通信准备\n请稍后");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}通信已取消");
static const u8 sText_OnlyPkmnForBattle[] = _("这是最后一只\n宝可梦了");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}正在等待你的朋友…");
static const u8 sText_YourFriendWantsToTrade[] = _("你的朋友\n想交换宝可梦");
