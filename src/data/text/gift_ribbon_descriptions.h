const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("03年地区锦标赛");
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("的冠军缎带");
const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("03年全国锦标赛");
const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("03年世界杯");
const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("的亚军缎带");
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("的半决赛选手缎带");
const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("04年地区锦标赛");
const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("04年全国锦标赛");
const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("04年世界杯");
const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("05年地区锦标赛");
const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("05年全国锦标赛");
const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("05年世界杯");
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("宝可梦战杯");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("的参与缎带");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("宝可梦联盟");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("晋升杯");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("宝可梦联赛");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("的参与缎带");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("宝可梦活动");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("宝可梦节日");
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("完成困难难度");
const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("的纪念缎带");
const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("授予宝可梦完成");
const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("所有挑战的缎带。");
const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("100连胜");
const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("完成暗黑塔");
const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("完成赤红塔");
const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("完成黑钢塔");
const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("完成最终塔");
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("造就传奇");
...
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("暑假缎带");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("寒假缎带");
const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("春假缎带");
const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("常磐缎带");
const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("特殊节日缎带");
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("勤奋努力的象征缎带");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("交际广泛的象征缎带");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("充满活力的象征缎带");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("谨此缎带授予被");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("珍爱的宝可梦");
