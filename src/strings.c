...
const u8 gText_Littleroot[] = _("若至"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_Berries2[] = _("树果"); // Unused
...
const u8 gText_PkmnFainted_FldPsn[] = _("{STR_VAR_1}力尽倒下了…");
#else
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}逊");
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}快");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}最速传说");
