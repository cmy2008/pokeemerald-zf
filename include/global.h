...
// TODO: #define FREE_MATCH_CALL                 //frees up match call data. 104 bytes
...
struct SaveBlock1
{
    ...
    /*0x988*/ u8 filler1[0x34]; // Previously Dex Flags, feel free to remove.   //52 bytes
    #endif
    ...
    /*0x3???*/ u8 registeredTexts[UNION_ROOM_KB_ROW_COUNT][21]; //210 bytes
    #endif
    #ifndef FREE_TRAINER_HILL
    /*0x3???*/ struct TrainerHillSave trainerHill;  //12 bytes
    #endif
